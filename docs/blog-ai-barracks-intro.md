...
v0.8.2에서 도입하고 v0.9.0에서 크게 강화한 기능입니다.
...
| 배럭 | 용도 | 세션 수 | wiki 토픽 |
|------|------|---------|----------|
| ai_barracks_management | 시스템 개발/관리 | 30+ | CLI 아키텍처, 에이전트 엔지니어링 리서치 |
| career_management | 면접 준비 | 25+ | 8개 (팀 구조, 기술 아티클, 예상 질문 70+) |
| choihouse_finance | 개인 재정 | Slack 경유 | 증여 전략 |
| data_engineering | 데이터 엔지니어링 | 3+ | ClickHouse, S3 Lakehouse |
...
**License**: MIT
**현재 버전**: CLI v0.9.0 / CommandCenter v0.1.0
